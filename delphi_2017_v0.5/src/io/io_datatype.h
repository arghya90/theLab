...
class CAtomPdb // delphi_pdb_file_record
{
   private:
      ...
      string strAtResname;  //residue name -- Surface potential
      string strAtIndex;    //atomIndex -- modified gaussian
   ...
   public:
       ...
       * @param strResname string of the line containing the residue name info in .pdb for this atom
       */
      void setAtResname(const string strAtResnameIn) {this->strAtResname = strAtResnameIn;}

      /**
       * function to store the ratom index as read from .pdb file for this atom
       * @param strAtIndexIN string of the line containing the atom index info in .pdb for this atom
       */
      void setAtIndex(const string strAtIndexIn) {this->strAtIndex = strAtIndexIn;}
      ...
      /**
       * function to get atom index of this atom
       * @return string containing atomIndex of this atom
       */
      //string getAtIndex() const {return this->strAtIndex;}
};
